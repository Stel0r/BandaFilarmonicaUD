...
insert into convocatoriaestudiante values('MSIM', 002, '20201020009','VIOL',to_date('02/07/2023','dd/mm/yyyy'),to_date('09/07/2023','dd/mm/yyyy'),4.4);
insert into convocatoriaestudiante values('MSIM', 003, '20201020036','VIOL',to_date('02/07/2023','dd/mm/yyyy'),to_date('09/07/2023','dd/mm/yyyy'),4.8);
insert into convocatoriaestudiante values('MSIM', 004, '20201020008','CANT',to_date('02/07/2023','dd/mm/yyyy'),to_date('09/07/2023','dd/mm/yyyy'),4.5);
insert into convocatoriaestudiante values('MSIM', 005, '20221413013', 'VIOA', to_date('02/07/2023','dd/mm/yyyy'), to_date('09/07/2023','dd/mm/yyyy'), 2);
insert into convocatoriaestudiante values('MSIM', 006, '20220909009', 'FLAU', to_date('02/07/2023','dd/mm/yyyy'), to_date('09/07/2023','dd/mm/yyyy'), 4.5);
insert into convocatoriaestudiante values('MSIM', 007, '20211211011', 'VIOA', to_date('02/07/2023','dd/mm/yyyy'), to_date('09/07/2023','dd/mm/yyyy'), 4.6);
insert into convocatoriaestudiante values('MSIM', 008, '20210404004', 'BAJO', to_date('02/07/2023','dd/mm/yyyy'), to_date('09/07/2023','dd/mm/yyyy'), 4.7);
insert into convocatoriaestudiante values('MSIM', 009, '20200505005', 'CANT', to_date('02/07/2023','dd/mm/yyyy'), to_date('09/07/2023','dd/mm/yyyy'), 1);
insert into convocatoriaestudiante values('MSIM', 010, '20220606006', 'BAJO', to_date('02/07/2023','dd/mm/yyyy'), to_date('09/07/2023','dd/mm/yyyy'), 4.4);
insert into convocatoriaestudiante values('MSIM', 011, '20210707007', 'FLAU', to_date('02/07/2023','dd/mm/yyyy'), to_date('09/07/2023','dd/mm/yyyy'), 5);

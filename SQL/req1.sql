...
Insert into generoobra values('MF','Musica Folclórica');
...
insert into perido values(2022);
insert into perido values(2023);
insert into perido values(2020);
insert into perido values(2021);
insert into perido values(2019);
...
insert into obra values('MSIM','MC','DEU',2023,'BAC',to_date('27/07/1733','DD/MM/YYYY'),'Misa en si menor',1);
insert into obra values('PSSM','MC','DEU',2022,'BAC',to_date('15/04/1729','DD/MM/YYYY'),'Pasion de segun San Mateo',0);
insert into obra values('REQU','MC','AUT',2022,'MOZ',to_date('02/01/1793','DD/MM/YYYY'),'Requiem',0);
insert into obra values('MESI','MC','DEU',2021,'HAN',to_date('13/04/1742','DD/MM/YYYY'),'Mesias',0);
insert into obra values('REAL','MC','DEU',2021,'BRA',to_date('10/04/1868','DD/MM/YYYY'),'Un Requiem Aleman',0);
...
insert into listaactividadUD values(2023,'EVAMU','Evaluador Musical',80.00,8);
insert into listaactividadUD values(2023,'DIRMU','Dirección Musical',15.00,8);
insert into listaactividadUD values(2023,'COOSI','Coordinador Sinfornica',10.00,8);
insert into listaactividadUD values(2023,'AUXGE','Auxiliar General',25.00,8);
...
insert into estudiante values('20230303003', 'INGSI', 'Andrés', 'López', to_date('14/08/2023','dd/mm/yyyy'), to_date('05/03/2001','dd/mm/yyyy'), 'andres.lopez@gmail.com');
insert into estudiante values('20210404004', 'INGSI', 'Laura', 'Martínez', to_date('02/07/2021','dd/mm/yyyy'), to_date('18/11/1998','dd/mm/yyyy'), 'laura.martinez@gmail.com');
insert into estudiante values('20200505005', 'ARTES', 'Carlos', 'Rodríguez', to_date('30/06/2020','dd/mm/yyyy'), to_date('23/09/2000','dd/mm/yyyy'), 'carlos.rodriguez@gmail.com');
insert into estudiante values('20230606006', 'ARTDA', 'Ana', 'Hernández', to_date('05/03/2023','dd/mm/yyyy'), to_date('15/02/1997','dd/mm/yyyy'), 'ana.hernandez@gmail.com');
insert into estudiante values('20210707007', 'ARTDA', 'Pedro', 'Sánchez', to_date('25/12/2021','dd/mm/yyyy'), to_date('08/06/1996','dd/mm/yyyy'), 'pedro.sanchez@gmail.com');
insert into estudiante values('20200808008', 'ARTMU', 'Sofía', 'Ramírez', to_date('11/09/2020','dd/mm/yyyy'), to_date('29/04/1995','dd/mm/yyyy'), 'sofia.ramirez@gmail.com');
...
insert into estudiante values('20231010010', 'ARTES', 'Ana', 'Gómez', to_date('28/03/2023','dd/mm/yyyy'), to_date('12/09/1997','dd/mm/yyyy'), 'ana.gomez@gmail.com');
...
insert into estudiante values('20201312012', 'ARTES', 'María', 'López', to_date('10/05/2020','dd/mm/yyyy'), to_date('20/02/1998','dd/mm/yyyy'), 'maria.lopez@gmail.com');
insert into estudiante values('20221413013', 'ARTMU', 'Pedro', 'García', to_date('07/11/2022','dd/mm/yyyy'), to_date('15/07/1995','dd/mm/yyyy'), 'pedro.garcia@gmail.com');
insert into estudiante values('20201514014', 'ARTDA', 'Laura', 'Martínez', to_date('19/09/2020','dd/mm/yyyy'), to_date('10/04/1994','dd/mm/yyyy'), 'laura.martinez@gmail.com');

--creamos la convocatoria
insert into convocatoriaestudiante values('MSIM',001,'20201020009','VIOL',to_date('02/02/2023','dd/mm/yyyy'),to_date('17/02/2023','dd/mm/yyyy'),4.4);
insert into convocatoriaestudiante values('MSIM',002,'20201020036','VIOL',to_date('02/02/2023','dd/mm/yyyy'),to_date('17/02/2023','dd/mm/yyyy'),4.8);
insert into convocatoriaestudiante values('MSIM',003,'20201020008','CANT',to_date('02/02/2023','dd/mm/yyyy'),to_date('17/02/2023','dd/mm/yyyy'),4.5);
insert into convocatoriaestudiante values('MSIM', 004, '20221413013', 'VIOL', to_date('02/02/2023','dd/mm/yyyy'), to_date('17/02/2023','dd/mm/yyyy'), 2);
insert into convocatoriaestudiante values('MSIM', 005, '20220909009', 'FLAU', to_date('02/02/2023','dd/mm/yyyy'), to_date('17/02/2023','dd/mm/yyyy'), 4.5);
insert into convocatoriaestudiante values('MSIM', 006, '20211211011', 'FLAU', to_date('02/02/2023','dd/mm/yyyy'), to_date('17/02/2023','dd/mm/yyyy'), 4.6);
insert into convocatoriaestudiante values('MSIM', 007, '20210404004', 'BAJO', to_date('02/02/2023','dd/mm/yyyy'), to_date('17/02/2023','dd/mm/yyyy'), 4.7);
insert into convocatoriaestudiante values('MSIM', 008, '20200505005', 'CANT', to_date('02/02/2023','dd/mm/yyyy'), to_date('17/02/2023','dd/mm/yyyy'), 1);
insert into convocatoriaestudiante values('MSIM', 009, '20230606006', 'VIOA', to_date('02/02/2023','dd/mm/yyyy'), to_date('17/02/2023','dd/mm/yyyy'), 4.4);
insert into convocatoriaestudiante values('MSIM', 010, '20210707007', 'VIOA', to_date('02/02/2023','dd/mm/yyyy'), to_date('17/02/2023','dd/mm/yyyy'), 5);
...
insert into laborpersonalobra values(0001,'FACIN',0002,'PROR',0001,2023,'DIRMU',2);
insert into laborpersonalobra values(0002,'FACIN',0002,'PROR',0001,2023,'EVAMU',2);
insert into laborpersonalobra values(0003,'FACIN',0002,'PROV',0001,2023,'COOSI',2);
insert into laborpersonalobra values(0004,'FACIN',0002,'PROV',0001,2023,'EVAMU',2);
insert into laborpersonalobra values(0005,'FACAR',0002,'PROZ',0001,2023,'EVAMU',2);
insert into laborpersonalobra values(0006,'VICRE',0001,'VIC2',0001,2023,'AUXGE',2);
insert into laborpersonalobra values(0007,'VICRE',0001,'VIC3',0001,2023,'AUXIN',2);

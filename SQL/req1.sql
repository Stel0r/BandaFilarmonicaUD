...
insert into listaactividadUD values(202301,'DIRMU','Dirección Musical',15.00,8);
...
insert into estudiante values('20220303003', 'INGSI', 'Andrés', 'López', to_date('14/08/2022','dd/mm/yyyy'), to_date('05/03/2001','dd/mm/yyyy'), 'andres.lopez@gmail.com');
...
insert into estudiante values('20220606006', 'ARTDA', 'Ana', 'Hernández', to_date('05/03/2022','dd/mm/yyyy'), to_date('15/02/1997','dd/mm/yyyy'), 'ana.hernandez@gmail.com');
...
insert into estudiante values('20221010010', 'ARTES', 'Ana', 'Gómez', to_date('28/03/2022','dd/mm/yyyy'), to_date('12/09/1997','dd/mm/yyyy'), 'ana.gomez@gmail.com');
...
insert into convocatoriaestudiante values('MSIM', 001,'20201020009','VIOL',to_date('02/04/2023','dd/mm/yyyy'),to_date('09/04/2023','dd/mm/yyyy'),4.4);
insert into convocatoriaestudiante values('MSIM', 002,'20201020036','VIOL',to_date('02/04/2023','dd/mm/yyyy'),to_date('09/04/2023','dd/mm/yyyy'),4.8);
insert into convocatoriaestudiante values('MSIM', 003,'20201020008','CANT',to_date('02/04/2023','dd/mm/yyyy'),to_date('09/04/2023','dd/mm/yyyy'),4.5);
insert into convocatoriaestudiante values('MSIM', 004, '20221413013', 'VIOL', to_date('02/04/2023','dd/mm/yyyy'), to_date('09/04/2023','dd/mm/yyyy'), 2);
insert into convocatoriaestudiante values('MSIM', 005, '20220909009', 'FLAU', to_date('02/04/2023','dd/mm/yyyy'), to_date('09/04/2023','dd/mm/yyyy'), 4.5);
insert into convocatoriaestudiante values('MSIM', 006, '20211211011', 'FLAU', to_date('02/04/2023','dd/mm/yyyy'), to_date('09/04/2023','dd/mm/yyyy'), 4.6);
insert into convocatoriaestudiante values('MSIM', 007, '20210404004', 'BAJO', to_date('02/04/2023','dd/mm/yyyy'), to_date('09/04/2023','dd/mm/yyyy'), 4.7);
insert into convocatoriaestudiante values('MSIM', 008, '20200505005', 'CANT', to_date('02/04/2023','dd/mm/yyyy'), to_date('09/04/2023','dd/mm/yyyy'), 1);
insert into convocatoriaestudiante values('MSIM', 009, '20220606006', 'VIOA', to_date('02/04/2023','dd/mm/yyyy'), to_date('09/04/2023','dd/mm/yyyy'), 4.4);
insert into convocatoriaestudiante values('MSIM', 010, '20210707007', 'VIOA', to_date('02/04/2023','dd/mm/yyyy'), to_date('09/04/2023','dd/mm/yyyy'), 5);
